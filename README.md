...
<img width="1536" height="1024" alt="iter 시스템구성도" src="https://github.com/user-attachments/assets/86a62947-5965-440e-9aac-13bba4c7b3d7" />
...
설계 결정의 배경과 측정 기록은 로컬 `.docs/` 디렉터리에 문서 13편으로 정리돼 있습니다
(로컬 작업 문서라 저장소에는 포함되지 않습니다).
