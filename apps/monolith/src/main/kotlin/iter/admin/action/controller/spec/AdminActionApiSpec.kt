package iter.admin.action.controller.spec
...
interface AdminActionApiSpec {
    ...
    fun getAdminActions(@Valid @ParameterObject request: AdminActionSearchRequest): ResponseEntity<CursorPageResponse<AdminActionResponse>>
}
