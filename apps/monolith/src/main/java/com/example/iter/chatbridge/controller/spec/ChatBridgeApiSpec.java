package com.example.iter.chatbridge.controller.spec;
...
public interface ChatBridgeApiSpec {
    ...
    ResponseEntity<ChatTicketResponse> issueTicket(
    ...
    ResponseEntity<ChatInquiryGrantResponse> issueInquiryGrant(
            @AuthenticationPrincipal CustomUserDetails principal,
            @Valid ChatInquiryGrantRequest request
    );
}
