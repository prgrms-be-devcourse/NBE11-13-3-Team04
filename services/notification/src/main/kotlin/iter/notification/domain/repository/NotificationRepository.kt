package iter.notification.domain.repository

import iter.notification.domain.entity.Notification
...
interface NotificationRepository : JpaRepository<Notification, Long> {
    ...
    fun findNextUnreadByReceiverId(
        @Param("receiverId") receiverId: Long?,
        @Param("cursorCreatedAt") cursorCreatedAt: LocalDateTime?,
        @Param("cursorId") cursorId: Long?,
        pageable: Pageable,
    ...
    fun markAllAsRead(@Param("receiverId") receiverId: Long, @Param("readAt") readAt: LocalDateTime): Int
}
