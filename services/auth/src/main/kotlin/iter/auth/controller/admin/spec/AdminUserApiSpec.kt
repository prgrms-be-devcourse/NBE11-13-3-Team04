package iter.auth.controller.admin.spec
...
interface AdminUserApiSpec {
    ...
    fun getUsers(@Valid @ParameterObject request: AdminUserSearchRequest): ResponseEntity<CursorPageResponse<AdminUserSummaryResponse>>
    ...
    fun updateStatus(
        ...
        @SwaggerRequestBody(description = "변경할 회원 상태와 관리자 처리 사유", required = true)
        @Valid
