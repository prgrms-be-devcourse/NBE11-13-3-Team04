...
interface RentalCommandPort {
    ...
    //
    // rentalId 는 nullable 로 선언한다(payment/service 의 PaymentServiceTest·
    // TossWebhookServiceTest 가 never() 검증에서 타입 미지정 any() 를 쓴다 —
    // Mockito any()/boxed Long 함정, device D7/reservation R6 문서 참고).
    fun markPaymentConfirmed(rentalId: Long?): Optional<RentalInfo>
}
