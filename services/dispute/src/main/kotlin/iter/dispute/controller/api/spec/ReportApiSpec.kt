package iter.dispute.controller.api.spec
...
interface ReportApiSpec {
    ...
    fun createReport(
        ...
        @SwaggerRequestBody(description = "신고 대상 유형·ID와 신고 사유·내용", required = true)
        @Valid
        request: ReportCreateRequest
    ): ResponseEntity<ReportDetailResponse>

    @Operation(summary = "내 신고 목록 조회", description = "로그인 사용자가 작성한 신고만 대상 유형과 처리 상태 조건으로 조회합니다.")
    @ApiResponses(
        value = [
