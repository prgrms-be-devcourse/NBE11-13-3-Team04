...
import iter.dispute.domain.repository.spec.ReportSpecifications
...
import iter.dispute.util.ReportMapper
...
class ReportService(
    ...
    private fun validateDuplicateActiveReport(reporterId: Long, targetType: iter.dispute.domain.entity.ReportTargetType, targetId: Long) {
