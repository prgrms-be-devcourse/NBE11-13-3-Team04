...
interface RentalHistoryApiSpec {
    ...
    @Operation(summary = "빌린 장비 이력 조회", description = "로그인 사용자가 대여자인 거래를 상태와 예약 당시 장비명으로 검색합니다.")
    @ApiResponses(
        value = [
    ...
    @Operation(summary = "빌려준 장비 이력 조회", description = "로그인 사용자가 등록한 장비의 대여 거래를 상태와 예약 당시 장비명으로 검색합니다.")
    @ApiResponses(
        value = [
    ...
    @Operation(summary = "빌린 장비 연체 이력 조회", description = "로그인 사용자가 빌린 거래 중 종료일이 지났고 아직 정상 반환되지 않은 거래를 조회합니다.")
    @ApiResponses(
        value = [
    ...
    @Operation(summary = "빌려준 장비 연체 이력 조회", description = "로그인 사용자가 빌려준 거래 중 종료일이 지났고 아직 정상 반환되지 않은 거래를 조회합니다.")
    @ApiResponses(
        value = [
